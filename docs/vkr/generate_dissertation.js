...
function generateBibliography() {
  ...
  const sources = [
    // Russian sources (alphabetical), then English sources (alphabetical)
    // 1
    ...
    // 3
    "Василенко, О.Н. Теоретико-числовые алгоритмы в криптографии / О.Н. Василенко. \u2013 2-е изд., перераб. \u2013 М.: МЦНМО, 2019. \u2013 328 с.",
    // 4
    ...
    // 14
    "Смарт, Н. Криптография: учебный курс / Н. Смарт. \u2013 М.: Техносфера, 2021. \u2013 544 с.",
    // 15
    "Столлингс, В. Криптография и защита сетей: принципы и практика / В. Столлингс. \u2013 7-е изд. \u2013 М.: Вильямс, 2021. \u2013 768 с.",
    // 16
    ...
    // 17
    "Фомичев, В.М. Дискретная математика и криптология: курс лекций / В.М. Фомичев. \u2013 2-е изд. \u2013 М.: Диалог-МИФИ, 2019. \u2013 400 с.",
    // 18
    "Черёмушкин, А.В. Криптографические протоколы: основные свойства и уязвимости / А.В. Черёмушкин. \u2013 М.: Академия, 2019. \u2013 272 с.",
    // 19
    "Шеннон, К.Э. Работы по теории информации и кибернетике / К.Э. Шеннон. \u2013 М.: ИЛ, 1963. \u2013 830 с.",
    // 20
    "Шнайер, Б. Прикладная криптография. Протоколы, алгоритмы, исходные тексты на языке Си / Б. Шнайер. \u2013 2-е изд. \u2013 М.: Триумф, 2016. \u2013 816 с.",
    // English sources (alphabetical)
    // 21
    ...
    // 23
    "Cover, T.M. Elements of Information Theory / T.M. Cover, J.A. Thomas. \u2013 2nd ed. \u2013 Wiley, 2006. \u2013 776 p.",
    // 24
    "Daemen, J. The Design of Rijndael: AES \u2013 The Advanced Encryption Standard / J. Daemen, V. Rijmen. \u2013 2nd ed. \u2013 Springer, 2020. \u2013 272 p.",
    // 25
    "Docker Documentation [Электронный ресурс]. \u2013 URL: https://docs.docker.com/ (дата обращения: 21.03.2026).",
    // 26
    "FastAPI Documentation [Электронный ресурс]. \u2013 URL: https://fastapi.tiangolo.com/ (дата обращения: 21.03.2026).",
    // 27
    "FIPS 197. Advanced Encryption Standard (AES). \u2013 NIST, 2001. \u2013 51 p.",
    // 28
    "FIPS 46-3. Data Encryption Standard (DES). \u2013 NIST, 1999. \u2013 22 p.",
    // 29
    "Fluhrer, S. Weaknesses in the Key Scheduling Algorithm of RC4 / S. Fluhrer, I. Mantin, A. Shamir // Selected Areas in Cryptography \u2013 SAC 2001. \u2013 Springer, 2001. \u2013 P. 1\u201324.",
    // 30
    "Katz, J. Introduction to Modern Cryptography / J. Katz, Y. Lindell. \u2013 3rd ed. \u2013 CRC Press, 2021. \u2013 626 p.",
    // 31
    ...
    // 33
    "NumPy Documentation [Электронный ресурс]. \u2013 URL: https://numpy.org/doc/ (дата обращения: 21.03.2026).",
    // 34
    "Paar, C. Understanding Cryptography: A Textbook for Students and Practitioners / C. Paar, J. Pelzl. \u2013 2nd ed. \u2013 Springer, 2024. \u2013 410 p.",
    // 35
    "PyCryptodome Documentation [Электронный ресурс]. \u2013 URL: https://pycryptodome.readthedocs.io/ (дата обращения: 21.03.2026).",
    // 36
    "React Documentation [Электронный ресурс]. \u2013 URL: https://react.dev/ (дата обращения: 21.03.2026).",
    // 37
    "Recharts Documentation [Электронный ресурс]. \u2013 URL: https://recharts.org/ (дата обращения: 21.03.2026).",
    // 38
    "SciPy Documentation [Электронный ресурс]. \u2013 URL: https://docs.scipy.org/ (дата обращения: 21.03.2026).",
    // 39
