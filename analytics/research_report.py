...
def generate_markdown_report(
    ...
    conclusions = (
        ...
        f"4. Блочные шифры (AES, DES, 3DES, ГОСТ 28147-89, Blowfish) демонстрируют лучший лавинный эффект "
        ...
        f"Для задач, требующих высокой криптостойкости, следует применять AES-256, ГОСТ 28147-89 или 3DES."
    )
