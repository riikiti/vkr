...
from visualization.entropy_plots import (
    plot_entropy_by_algorithm, plot_entropy_interactive,
    plot_entropy_vs_data_size, plot_entropy_heatmap,
)
...
if run_button or "entropy_df" in st.session_state:
    ...
    with tab2:
        ...
        st.subheader("Тепловая карта: алгоритм x тип данных")
    ...
    with tab4:
        ...
        st.subheader("Результаты хи-квадрат теста")
